...
{
    [CustomEditor(typeof(SubstanceInputValueProfile))]
    public class SubstanceInputValueProfileEditor : Editor
    {
        protected readonly GUIContent kValuesLabel = new GUIContent("Values", "Values to set on a SubstanceNativeGraph.");
        ...
        protected virtual void OnEnable()
        {
            ...
            addMenuData = SubstanceExtensionsEditorUtility.GetAddMenuData(typeof(ISubstanceInputValue));
        }
        ...
        protected void AddValue(int index)
        {
            ...
            newValue.managedReferenceValue = (ISubstanceInputValue)constructorInfo.Invoke(new object[0]);
