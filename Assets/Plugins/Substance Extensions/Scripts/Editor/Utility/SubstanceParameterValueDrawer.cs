...
namespace SOS.SubstanceExtensionsEditor
{
    ...
    public class SubstanceParameterValueDrawer : PropertyDrawer
    {
        private class Labels
        {
            ...
            public static readonly GUIContent BoolLabel = new GUIContent("Value", "Bool value for the parameter. (This is a convenience wrapper for an Int parameter)");
            public static readonly GUIContent ColorLabel = new GUIContent("Value", "Color value for the parameter. (This is a convenience wrapper for a Float4 parameter)");
            ...
            if(property.isExpanded)
            {
                ...
                switch(valueType)
                {
                    ...
                    case SubstanceValueType.Float3:
                        ...
                        {
                            position.y += position.height + EditorGUIUtility.standardVerticalSpacing;
                            Vector3 float3Val = float3Property.vector4Value;
                    ...
                    case SubstanceValueType.Float4:
                        ...
                        if(widgetType == SubstanceWidgetType.Color)
                        {
                            ...
                            EditorGUI.BeginChangeCheck();
                            float4Val = EditorGUI.ColorField(position, Labels.ColorLabel, float4Val);
                            if(EditorGUI.EndChangeCheck())
                            {
